...
class Packager {
    ...
    constructor(options, cancellationToken) {
        ...
        try {
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)("electron-builder " + "19.13.0");
        } catch (e) {
    ...
    installAppDependencies(platform, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (config.buildDependenciesFromSource === true && platform.nodeName !== process.platform) {
                ...
                yield (0, (_yarn || _load_yarn()).installOrRebuild)(config, _this4.appDir, frameworkInfo, platform.nodeName, (_core || _load_core()).Arch[arch]);
            }
        })();
    }
    afterPack(context) {
